      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16">
          ...
          <motion.div variants={FADE_UP_VARIANTS} className="hidden md:block">
            <Link to="/blog" className="flex items-center gap-2 text-white hover:text-[#CCFF00] transition-colors group font-bold uppercase tracking-wider text-sm font-['Inter']">
        ...
        >
          <Link to="/blog" className="inline-flex items-center gap-2 text-white hover:text-[#CCFF00] transition-colors group font-bold uppercase tracking-wider text-sm font-['Inter']">
            View All <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </motion.div>
      </motion.div>
