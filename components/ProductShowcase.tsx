...
const SHOWCASE_PRODUCTS = [
  {
    ...
    description:
      "The soda that everybody loves. Sweet, tangy, and expertly formulated for that perfect citrus kick.",
    color: "#F37021",
    image: orange,
  },

  {
    ...
    description:
      "A deep, rich cola flavor packed with maximum fizz. The undeniable champion of any gathering.",
    color: "#ED1C24",
    image: cola,
  },
  {
    ...
    description:
      "The nostalgic favorite. Sweet, creamy, and brimming with our signature vanilla smooth finish.",
    color: "#00A651",
    image: creamsoda,
  },
  {
    ...
    description:
      "A cool, delicate infusion of tea and peach. A sophisticated, light, and fruity escape.",
    color: "#008B8B",
    image: nesta,
  },
];
          ...
          <div className="w-screen h-full shrink-0 flex flex-col justify-center items-center px-[8vw]">
            <div className="max-w-2xl flex flex-col items-center text-center">
              ...
              <p className="text-white/50 text-lg md:text-xl font-mplus font-light leading-relaxed max-w-lg mt-4">
                Scroll to explore our exclusive collection of flagship
                beverages, meticulously formulated for maximum refreshment.
              </p>
            </div>
          </div>
