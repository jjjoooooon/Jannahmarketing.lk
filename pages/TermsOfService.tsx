    ...
    return (
        <div className="bg-[#050505] min-h-screen text-white pt-32 pb-20">
            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-black mb-8 font-['Plus_Jakarta_Sans'] text-[#CCFF00]">Terms of Service</h1>
                    <p className="text-gray-400 mb-8">Last updated: January 6, 2026</p>

                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">1. Agreement to Terms</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">2. Intellectual Property Rights</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">3. User Representations</h2>
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">4. Products</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">5. Purchases and Payment</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">6. Return Policy</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">7. Prohibited Activities</h2>
                        <p className="text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">8. Modifications and Interruptions</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">9. Governing Law</h2>
                        <p className="text-gray-300">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 font-['Plus_Jakarta_Sans']">10. Contact Us</h2>
                        <p className="text-gray-300">
                            In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: <a href="mailto:hello@jannahmarketing.lk" className="text-[#CCFF00] hover:underline">hello@jannahmarketing.lk</a>.
                        </p>
                    </section>
                </motion.div>
            </div>
